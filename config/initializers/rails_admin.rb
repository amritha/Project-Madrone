...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Projectmadrone', 'Admin']
  ...
  #   # Found associations:
  #     configure :voteable, :polymorphic_association         # Hidden 
  #     configure :voter, :polymorphic_association         # Hidden   #   # Found columns:
  #     configure :id, :integer 
